...
const whatsappMessage = encodeURIComponent(
   "I found this useful calorie calculator tool, check it out: https://seosaurus.in/tools/calorie-needed-calculator/"
  );

  const toolUrl = "https://seosaurus.in/tools/calorie-needed-calculator/";
